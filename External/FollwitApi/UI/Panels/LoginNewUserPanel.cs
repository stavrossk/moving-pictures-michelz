...
namespace Follwit.API.UI.Panels {
    public partial class LoginNewUserPanel : UserControl {
        ...
        private void CheckUsername() {
            ...
            ThreadStart actions = delegate {
                ...
                try { usernameAvailable = FollwitApi.IsUsernameAvailable(usernameTextBox.Text, ApiUrl); }
                catch (Exception ex) {
                    UnexpectedError(ex);
                    return;
                }
